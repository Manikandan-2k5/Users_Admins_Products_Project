...
public class ValidateAdminSessionInterceptor implements Interceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		if(session!=null && browserSession!=null) {
			boolean isValidSession = CredentialsAccessObject.validateAdminSession(session, browserSession);
			if(isValidSession) {
