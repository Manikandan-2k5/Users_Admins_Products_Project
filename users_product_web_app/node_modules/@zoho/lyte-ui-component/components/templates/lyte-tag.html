				...
				<div class="lyteMultiSelect">
					<ul class="lyteMultipleSelect">
						...
						<li class="lyteTagInputLi">
							<input placeholder={{ltPropPlaceholder}} class="lyteDropdownTextField" type="text" oninput={{action('searchItemsOnInput',event)}} onblur={{action('searchItemsOnBlur',event)}} onkeydown={{action('handleOtherKeys',event)}} disabled={{ltPropDisabled}} />
						</li>
					</ul>
				</div>
			</lyte-drop-button>
