<template tag-name="lyte-video">
    <div tabindex="0" class="lyteVideoContainer lyteVideoControlsShow" onpointerenter="{{action('mouseEnter',event)}}" onpointerleave="{{action('mouseLeave', event)}}" onpointermove="{{action('mouseMove',event)}}" onkeydown="{{action('keyDown', event)}}"  >
        ...
        <%if(renderPrefetch && prefetchLoading == "lyteVideoPrefetchLoading"){%>
        ...
        <%}%>
        <canvas class="lyteVideoPoster {{if(renderPrefetch, 'lyteVideoPosterBeforeVideoLoad')}}" onclick="{{action('clickOnVideo')}}"></canvas>
        <%if(renderPrefetch){%>
            ...
            <div class="lyteVideoControls hoverControls lyteVideoPrefetchControlsContainer">
                ...
                <div class="lyteVideoIconsWrap">
                    <div lyte-if="{{ltPropOptions.play != false}}" class="lyteVideoPlayPauseIconWrap">
                        <button class="lyteVideoIcons lyteVideoPlayIcon lyteVideoPaused" onclick="{{action('prefetch',this)}}"></button>
                    </div>
                    <div lyte-if="{{ltPropOptions.backward != false}}" class="lyteVideoRewind">
                        <button class="lyteVideoIcons lyteVideoRewindIcon" lt-prop-title="Play the video to enable controls"></button>
                    </div>
                    <div lyte-if="{{ltPropOptions.forward != false}}" class="lyteVideoForward">
                        <button class="lyteVideoIcons lyteVideoForwardIcon" lt-prop-title="Play the video to enable controls"></button>
                    </div>
                    ...
                    <div class="lyteVideoRightIcons">
                        <div lyte-if="{{ltPropOptions.settings != false}}" class="lyteVideoSettings">
                            <button class="lyteVideoIcons lyteVideoSettingsIcon" lt-prop-title="Play the video to enable controls" ></button>
                        </div>
                        <% if( isNotFirefox ){ %>
                        <div lyte-if="{{ltPropOptions.pip != false}}" class="lyteVideoPip">
                            <button class="lyteVideoIcons lyteVideoPipIcon" lt-prop-title="Play the video to enable controls" ></button>
                        </div>
                        <% } %>
                        <div lyte-if="{{ltPropOptions.fullScreen != false}}" class="lyteVideoFullScreenControl">
                            <button class="lyteVideoIcons lyteVideoFullScreen" lt-prop-title="Play the video to enable controls"></button>
                        </div>
                    </div>
