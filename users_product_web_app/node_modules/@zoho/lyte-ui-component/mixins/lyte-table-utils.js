Lyte.Mixin.register( 'lyte-table-utils',{
    ...
    _setLeftForInterSection : function( reset ){
        ...
        __this._setmeasure = fastdom.measure( function(){
            ...
            var th_rows = Array.from( __this.$node.querySelectorAll( 'lyte-thead lyte-tr' ) ),
            accumulatedTop = 0;
            ...
            th_rows.forEach( function( row, ___index ){
                ...
                if( __length + 1 ){
                    ...
                    fastdom.mutate( function(){
                        ...
                        rows = ___index ? [] : Array.from( tbody.children ),
                        intersectionDivs = [],
                        accumulatedWidth = 0,
                        accumulatedLeft = 0,
    ...
    stickyFunction : function( cell, isCss, property, value ){
        ...
        tbody = this.getTbody(),
        rows = cell.parentNode.previousElementSibling ? [] : Array.from( tbody.children ),
    ...
    getTd : function( cell, increment, isRightEdge ){
        ...
        return cell.parentNode.children[ __index ];
